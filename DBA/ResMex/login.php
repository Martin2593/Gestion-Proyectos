<?php 
     if( isset($_REQUEST['V']) )  
    { echo '<script>alert("El usuario o constraseña son incorrectos");</script>'; }          
?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">Log
                        <strong>in</strong>
                    </h2>
                    <hr>
                    <p></p>
                    <form role="form">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4">
                                <form name="formlogin" action="autentificacion.php" method="post">
                                    <label>Usuario</label>
